    ...
    */
    ...
    var B = /:[0-9]+$/,
        ...
        F = function(a, b) {
            ...
            "port" === b ? a.port = String(Number(a.hostname ? a.port : y.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname ||
...
(function() {
    ...
    */
    ...
    var bd = function(a) {
        ...
        ge = function(a, b, c) {
            1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j91", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua))
        };
    var qc = function() {
    ...
    function Pe(a) {
        try {
            if (!a.get(Qe) && (a.set(Qe, !0), !a.get("&gtm"))) {
                ...
                if (b) {
                    O["google.tagmanager.debugui2.queue"] || (O["google.tagmanager.debugui2.queue"] = [], Id("https://www.google-analytics.com/debug/bootstrap"));
    ...
    var td = function(a, b) {
            ...
            if ("cookie" == P(a, ac)) {
                ...
                a.get(je) && !a.get(Se) && (c = {}, d = (M ? df(c, "_gac_gb", !0) : {})[P(a, Na)], ef(c), d && 0 != d.length && (c = d[0], d = c.qa, c.labels && c.labels.length && (d += "." + c.labels.join(".")), a.data.set(Te, c.timestamp / 1E3), a.data.set(Se, d)))
            }
            if (a.get(Hd)) {
                c = be("_ga", !!a.get(cc));
                ...
                if (b || !a.get(Je)) g = !1;
                else if (g = a.get(F), void 0 ===
                    g || g("analytics_storage")) g = !1;
                else {
                    J(84);
                    a.data.set(Le, 1);
                    if (g = d._up)
                ...
                if (c || e || ca || l)
                    if (c && e && J(36), a.get(bc) || ye(a.get(Kd)) || g) {
                        ...
                        if (c) b: if (d = c.indexOf("."), -1 == d) J(22);
                                ...
                                J(11);
                                a.data.set(Q, d);
                                if (c = be("_gac", !!a.get(cc))) c = c.split("."), "1" != c[0] || 4 != c.length ? J(72) : ke(c[3], c[1]) ? J(71) :
        ...
        pd = function(a) {
            ...
            c && c.clientWidth && c.clientHeight &&
                ("CSS1Compat" === M.compatMode || !l) ? ca = [c.clientWidth, c.clientHeight] : l && (ca = [e.clientWidth, e.clientHeight]);
