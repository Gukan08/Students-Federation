...
function resolveEmbeddableStatuses(state: State): State {
    ...
    const embeddables = state.embeddables.reduce((accEmbeddables, embeddable) => {
        ...
        if (embeddableHelpers.isVisible(embeddable, visibleEmbIds)) {
            return [...accEmbeddables, { ...embeddable,
                disqualifier
            }];
        }
    ...
    return logStatusResolutionResults({ ...state,
        embeddables,
        locationHref
    });
}
        ...
        case actions.SET_ACTIVATION_RULES:
            {
                ...
                return resolveEmbeddableStatuses({ ...state,
                    embeddables
                });
            }
        ...
        case actions.SET_LOCATION_HREF:
            {
                ...
                return locationHref === state.locationHref ?
                    state :
                    resolveEmbeddableStatuses({ ...state,
                        locationHref
                    });
            }
        ...
        case actions.FORM_SUBMIT_EVENT:
            {
                ...
                return {
                    ...
                    embeddables: state.embeddables.map(embeddable => (
                        ...
                        {
                            ...embeddable,
                            visitorData: visitorDataHelpers.addEmbeddableFormSubmit(embeddable.visitorData, isConversion),
                        } :
                        embeddable
                    )),
                };
        ...
        case actions.LINK_CLICK_EVENT:
            {
                ...
                return {
                    ...
                    embeddables: state.embeddables.map(embeddable => (
                        ...
                        {
                            ...embeddable,
                            visitorData: visitorDataHelpers.addEmbeddableLinkClick(embeddable.visitorData, isConversion),
                        } :
                        embeddable
                    )),
                };
